...
@section('content')
    ...
    <form action="{{ route('admin.say.update',$say->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('put')
        <div class="row">
            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" name="content" id="body" class="form-control">{{ $say->content }}</textarea>
                                </div>
