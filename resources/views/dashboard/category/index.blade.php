...
@section('content')
    ...
    <div class="card p-3">
        <div class="table-responsive">
            <a href="{{ route('admin.category.create') }}" class="btn btn-primary mb-2 mt-2">أضف جديد</a>
            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route("admin.category.edit",$category->id) }}" class="btn btn-primary">تعديل</a>
