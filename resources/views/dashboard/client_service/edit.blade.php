...
@section('content')
    ...
    <form action="{{ route('admin.client-service.update',$client->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('put')
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">اعدادات خدمة العملاء</h4>
                        @if ($errors->any())
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" name="body" id="body" class="form-control">{{ $client->body }}</textarea>
                                </div>
